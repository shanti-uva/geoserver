        ...
        <sld:UserStyle>
            ...
            <sld:FeatureTypeStyle>
                ...
                <sld:Rule>
                    ...
                    <sld:Title>up to 25% of Tibetans</sld:Title>
                    <sld:Abstract>Abstract</sld:Abstract>
                    <ogc:Filter>
                        <ogc:And>
                    ...
                    <sld:PolygonSymbolizer>
                        ...
                        <sld:Stroke>
                            <sld:CssParameter name="stroke">
                                <ogc:Literal>#7E7E7E</ogc:Literal>
                            </sld:CssParameter>
                ...
                <sld:Rule>
                    ...
                    <sld:Title>25% to 50% of Tibetans</sld:Title>
                    <sld:Abstract>Abstract</sld:Abstract>
                    <ogc:Filter>
                        <ogc:And>
                            <ogc:PropertyIsGreaterThanOrEqualTo>
                ...
                <sld:Rule>
                    ...
                    <sld:Title>50% to 75% of Tibetans</sld:Title>
                    <sld:Abstract>Abstract</sld:Abstract>
                    <ogc:Filter>
                        <ogc:And>
                            <ogc:PropertyIsGreaterThanOrEqualTo>
                ...
                <sld:Rule>
                    ...
                    <sld:Title>75% to 90% of Tibetan</sld:Title>
                    <sld:Abstract>Abstract</sld:Abstract>
                    <ogc:Filter>
                        <ogc:And>
                            <ogc:PropertyIsGreaterThanOrEqualTo>
                ...
                <sld:Rule>
                    ...
                    <sld:Title>90% to 99% of Tibetans</sld:Title>
                    <sld:Abstract>Abstract</sld:Abstract>
                    <ogc:Filter>
                        <ogc:And>
                            <ogc:PropertyIsGreaterThanOrEqualTo>
                            ...
                            <ogc:PropertyIsLessThanOrEqualTo>
                                <ogc:PropertyName>rate</ogc:PropertyName>
                                <ogc:Literal>0.9986</ogc:Literal>
                            </ogc:PropertyIsLessThanOrEqualTo>
                        </ogc:And>
                    </ogc:Filter>
                    <sld:MaxScaleDenominator>1.7976931348623157E308</sld:MaxScaleDenominator>
